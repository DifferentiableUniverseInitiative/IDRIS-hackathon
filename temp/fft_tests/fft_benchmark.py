...
def main(_):
  ...
  print('FLAGS.mesh_implementation: ',FLAGS.mesh_implementation) 
  print('mesh: ', mesh_shape.size)
  print('FLAGS.mesh_shape: ',FLAGS.mesh_shape)
  print('FLAGS.layout: ', FLAGS.layout)
